      ...
      link: function (scope, element, attrs) {
        ...
        angular.forEach(axisNames, function(axisName) {
          scope.$watch('config.' + axisName, function (newAxes, oldAxes) {
          	// WARNING!! This has commented out by BDO Labs as the config isn't always
          	// available before this directive runs. In those cases, the newAxes and
          	// the oldAxes will be equal, but not yet set on the highchart!
