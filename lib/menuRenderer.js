...
/**
 * Expose menuRenderer initialization.
 */

module.exports = function(app){
  app.directive('menuRenderer', ['$document', '$compile', '$state', '$injector', menuRenderer]);
};
...
function menuRenderer($document, $compile, $state, $injector) {
